...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['You Suck!', 0.2, 'F-'], //From 0% to 19%
		['Shit', 0.4, 'F'], //From 20% to 39%
		['Bad', 0.5, 'D-'], //From 40% to 49%
		['Bruh', 0.6, 'D'], //From 50% to 59%
		['Meh', 0.69, 'C-'], //From 60% to 68%
		['Nice', 0.7, 'C'], //69%
		['Good', 0.8, 'B-'], //From 70% to 79%
		['Great', 0.9, 'A'], //From 80% to 89%
		['Sick!', 1, 'S'], //From 90% to 99%
		['Perfect!!', 1, 'P'] //The value on this one isn't used actually, since Perfect is always "1"
	];
